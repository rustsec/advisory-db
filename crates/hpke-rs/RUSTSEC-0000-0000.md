...
In debug builds, Rust's default overflow checking causes a panic when the counter wraps past 2^32 - 1. In default release builds, the counter silently wraps to zero via `+=`, causing nonce reuse.
...
This vulnerability was originally disclosed as https://github.com/cryspen/hpke-rs/pull/TODO PR NUMBER HERE
